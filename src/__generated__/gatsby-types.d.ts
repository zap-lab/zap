...
type MarkdownRemarkFrontmatter = {
  ...
  readonly image: Maybe<MarkdownRemarkFrontmatterImage>;
};
...
type MarkdownRemarkFrontmatterFilterInput = {
  ...
  readonly image: Maybe<MarkdownRemarkFrontmatterImageFilterInput>;
};

type MarkdownRemarkFrontmatterImageFilterInput = {
...
type FileFieldsEnum =
  ...
  | 'childrenMarkdownRemark.frontmatter.image.alt'
  ...
  | 'childMarkdownRemark.frontmatter.image.alt'
...
type MarkdownRemarkFieldsEnum =
  ...
  | 'frontmatter.image.src.childrenMarkdownRemark'
...
type IndexLayoutQueryQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'keywords'>> }> };
